...
<body>
    <div class="overlay">
        <div class="job-container">
            ...
            <h2>Junior Web Application Developer - Infosys</h2>
            ...
            <div class="apply-by">
                <span style="font-weight: bold;">APPLY BY:</span> 9th March '24
            </div>
...
if(isset($_POST['name'], $_POST['roll_no'], $_POST['phone'], $_POST['email'])) {
    ...
    // Capturing and sanitizing form data
    ...
    $sql = "INSERT INTO student_table (Name, Roll_no, Mobile_number, Email_id, dtm) VALUES (?, ?, ?, ?, current_timestamp())";
    $stmt = mysqli_prepare($con, $sql);
    mysqli_stmt_bind_param($stmt, "ssss", $name, $roll_no, $phone, $email);
